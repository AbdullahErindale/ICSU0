...
print("It's possible Sanjay can distribute ", 12, end = ' ')
print("cookies for each bowl.")
cookies = 144
bowls = 6
print("Sanjay has", bowls, "bowls for",cookies, "cookies")
perBowl = cookies / bowls
print("The number of cookies per bowl is: %.0f"% perBowl)
